...
public class LivroDAO {
    ...
    public List<Autor> listarAutoresDeLivro(int idLivro) {
        Connection con = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        ...
        SELECT a.id, a.nome
        FROM Autor a
        JOIN Livro_Autor la ON a.id = la.idAutor
        WHERE la.idLivro = ?
    """;
        ...
        try {
            ...
            throw new RuntimeException("Erro ao listar autores do livro. Origem=" + ex.getMessage());
        } finally {
